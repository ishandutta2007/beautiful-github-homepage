...
因为 GitHub 的 API 每个小时只允许 5 千次请求，我的 `https://beautiful-github-homepage-vercel.vercel.app/api` 很有可能会触发限制。如果你将其托管在自己的 Vercel 服务器上，那么你就不必为此担心。点击 deploy 按钮来开始你的部署！
